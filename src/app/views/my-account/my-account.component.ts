...
export class MyAccountComponent implements OnInit {
  ...
  userRegister() {
    ...
    let url = "userportal/registration-step1";
    // var mob: any = this.registerForm.controls.phone.value;
    // this.mobileNum = mob.e164Number.replace("+", "")
    // //this.mobileNum = mob.number.replaceAll(/\s/g, '')
    let data = {
      ...
      mobile:   {
        type: "Mobile",
        number: this.registerForm.value.phone.e164Number,
        formatted: this.registerForm.value.phone.nationalNumber,
        marketing: true,
        is_inactive: false
        }
    };
    this.enableLoader = true;
    this._webService.noTokenPost(url, data).subscribe((response) => {
